...
class MossbauerFe33GUI(tk.Tk):
    ...
    def show_startup_splash(self) -> None:
        self.show_logo_popup(title="Mössbauer Fe-57", scale=2.0, click_to_close=True)
    ...
    def show_help(self) -> None:
        ...
        win = tk.Toplevel(self)
        win.title("Ayuda Mössbauer Fe-57")
        ...
        tk.Label(header, text="Ayuda Mössbauer Fe-57", bg="#075985", fg="white", font=("TkDefaultFont", 18, "bold")).pack(anchor=tk.W)
    ...
    def show_about(self) -> None:
        self.show_logo_popup(title=f"Acerca de Mössbauer Fe-57 v{APP_VERSION}", scale=2.6, click_to_close=False)
    ...
    def check_for_updates(self, silent: bool = False) -> None:
        ...
        _check(self, APP_VERSION, Path(__file__).resolve().parent, CONFIG_DIR,
               silent=silent, with_checksum=False)
