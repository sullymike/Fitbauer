...
COMPONENT_PARAM_SPECS = {
    ...
    # Polarización de las poblaciones de los dos estados (SPN de NORMOS):
    # p± = (1 ± P)/2. 0 = 50/50 (comportamiento histórico).
    "relax_polarization": ParamSpec(0.0, -1.0, 1.0, 0.01, 3),
