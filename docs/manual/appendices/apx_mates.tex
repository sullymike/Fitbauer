...
que Fitbauer reporta como «área \%». Admite las pendientes de correlación de
\S\ref{sec:dist-corr}.

\begin{figure}[htbp]\centering
  \includegraphics[width=0.82\textwidth]{apx_vbf}
  \caption{VBF (Rancourt--Ping). La distribución se modela como suma de
  gaussianas; como el núcleo está normalizado a área unidad, la amplitud $A_j$ de
  cada componente \emph{es} su área y su fracción $A_j/\sum_i A_i$ da la población
  del entorno. La suma (negro) reproduce la $P(\BHF)$ con pocos parámetros y sin
  regularización.}
  \label{fig:apx_vbf}
\end{figure}
