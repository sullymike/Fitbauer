...
\begin{figure}[htbp]\centering
  ...
  \caption{Distribución de desplazamiento isomérico. \emph{Izquierda}: una
  $P(\IS)$ con dos poblaciones separadas en $\delta$ —por ejemplo Fe$^{3+}$
  ($\delta\!\approx\!0{,}35$~mm/s) y Fe$^{2+}$ ($\delta\!\approx\!1{,}05$~mm/s)—
  refleja dos estados de oxidación o entornos. \emph{Derecha}: el espectro
  resultante es la superposición de los patrones de cada $\delta$; cuando los
  entornos solapan, la información los separa mejor que un ajuste discreto rígido.}
  \label{fig:apx_is}
\end{figure}
