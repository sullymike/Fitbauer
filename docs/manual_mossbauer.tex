...
\usepackage{graphicx}
% Figuras del anexo: se generan en docs/manual/img con
%   python docs/manual/scripts/make_appendix_figures.py
\graphicspath{{manual/img/}{img/}}
...
\subsection{Forma de onda del drive y eje de velocidad}\label{sec:drive}
...
\subsection{Máxima entropía (MaxEnt)}
...
\subsection{$\alpha$ adimensional}\label{sec:alpha-dimless}
...
\section{Correlación \texorpdfstring{$\delta(H)$}{d(H)} y \texorpdfstring{$\dEQ(H)$}{DEQ(H)} en el núcleo}\label{sec:dist-corr}
